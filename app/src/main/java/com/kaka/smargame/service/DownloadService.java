package com.kaka.smargame.service;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
               ...
               //     DeviceUtil.installAPK(mContext, new File(Config.UPDATE_APK_PAHT + "/" + FileUtil.getFileName(HttpClient.getDownloadUrl(mVersion.getAddress()))));
...
//                        mNotificationBuilder.build().setLatestEventInfo(mContext, "下载完成", "文件已下载完毕", contentIntent);
    ...
    public class DownloadBinder extends Binder {
        public void start() {
//            String apkFile = Constants.VERSION_UPDATE_APK_PAHT + "/" + FileUtil.getFileName(mVersion.getUrl());
//            // 检测是否已经下载过
...
//                URL url = new URL(HttpClient.getDownloadUrl(mVersion.getAddress()));
//
...
//                String apkFile = Config.UPDATE_APK_PAHT + "/" + FileUtil.getFileName(HttpClient.getDownloadUrl(mVersion.getAddress()));
