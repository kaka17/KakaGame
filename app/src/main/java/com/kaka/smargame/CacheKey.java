...
/**
 * Created by liaoc on 2015/6/27 0027.
 */
public class CacheKey {
    ...
    public static final String ALIASD_YES = ALIASD + "_yes";
    public static final String TAGD = "isTagd";
    public static final String TAGD_YES = TAGD + "_yes";
    public final static String OPEN_NOTIFICATION = "open_notification";
}
